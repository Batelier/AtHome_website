					...
					<fieldset>
						...
						<table>
							...
							<tr>
								...
								<td><input class="input_field" type="text" name="nom" id="nom" maxlength="20" placeholder="Dupont" required></td>
							</tr>
						<tr>
							<td><label for="email">Mail</label></td>
							<td><input class="input_field" type="email" name="email" id="email" placeholder="exemple@gmail.com" required></td>
						</tr>
						<tr>
							<td><label for="password">Mot de passe</label></td>
							<td><input class="input_field" type="password" name="password" id="password" required></td>
						</tr>
						<tr>
							<td><label for="password_check">Vérifier mot de passe</label></td>
							<td><input class="input_field" type="password" name="password_check" id="password" required></td>
						</tr>
						<tr>
							<td><label for="telFixe">Téléphone fixe</label></td>
							<td><input class="input_field" type="tel" name="telFixe" id="telFixe" maxlength="10" required></td>
						</tr>
						<tr>
							<td><label for="portable">Téléphone portable</label></td>
							<td><input class="input_field" type="tel" name="portable" id="portable" maxlength="10" required></td>	
						</tr>
						<tr>
							<td><label for="date">Date d'inscription</label></td>
							<td><input class="input_date" type="date" name="date" id="date" required></td>
						</tr>
						<tr>
							<td><label for="date">Type d'utilisateur</label></td>
							<td>
								<select class="input_select" required name='type'>
