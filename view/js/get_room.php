	...
	<div class="piece">
		<div class="infos_principales">
			<div class="nom_piece">
				...
				<div class="details">
					<button  onclick="popup_details()" class="button_details"name="details">Détails</button>
				</div>
				<div class="routine">
					<p>Routine : Eco</p>
				</div>
					...
					while ($donnees = $reponse->fetch()){
						...
						<div class="capteur">
							...
							<?php if ($donnees['model']=='RTY'){?>
								...
								<li><a href="routeur.php?cible=controller_send_trame">Action</a></li>	
								<!-- <form action="" method="post">
									<label class="switch">
										<input type="checkbox">
										<input type="hidden" name="etat_lum" value="0">
